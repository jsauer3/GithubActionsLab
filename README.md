[![Run App Jacob Sauer](https://github.com/jsauer3/GithubActionsLab/actions/workflows/run-app.yaml/badge.svg)](https://github.com/jsauer3/GithubActionsLab/actions/workflows/run-app.yaml)
